...
class PostForm(forms.ModelForm):
    class Meta:
        model = Post
        fields = ('title','game','body','header_image')
...
class EditGameForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'name':forms.TextInput(attrs={'class':'title-input','placeholder':'Create a title'}),
            'description':forms.Textarea(attrs={'class':'body-input','placeholder':'Add a description for your post'}),
            'category': forms.Select(choices=CATEGORIES,attrs={'class':'select-category'}),
            'steam_page':forms.TextInput(attrs={'class':'title-input','placeholder':'Create a title'}),
        }
